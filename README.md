...
<picture>
  ...
  <img alt="SQLWarden SQL editor with the schema browser and query results" src="docs/assets/screenshot-light.png">
</picture>
...
- **Full SQL editor** — split editor layouts, schema browsing and filtering, object details and diagrams, query results, explain plans, transactions, history, favorites, and same-browser multi-window sync.
...
- Go 1.26.6 or newer.
- Bun 1.3.10 for frontend dependency installation and builds.
...
Contribution proposals and issue discussions are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for the current external-contribution policy, commit conventions, development workflow, and release process.
