...
export function ExportConfirmDialog({ open, onOpenChange, sql, onConfirm }: ExportConfirmDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs text-muted-foreground">This query will run and the results will export as a file.</p>
