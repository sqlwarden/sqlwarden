...
function DropdownMenuRadioItem({
  ...
  return (
    <MenuPrimitive.RadioItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex min-h-7 cursor-pointer items-center gap-2 rounded-md py-1.5 pe-8 ps-2 text-xs outline-hidden select-none hover:bg-muted hover:text-foreground focus:bg-muted focus:text-foreground focus:**:text-foreground data-inset:ps-7.5 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
        className
      )}
      {...props}
    >
