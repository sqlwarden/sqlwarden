  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <Icon name="unfold-more" size={20} className="pointer-events-none size-3.5 text-muted-foreground" />
        }
      />
    </SelectPrimitive.Trigger>
  )
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <Icon name="tick-02" size={20} className="pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      {...props}
    >
      <Icon name="arrow-down-01" size={20} />
    </SelectPrimitive.ScrollDownArrow>
  )
}
