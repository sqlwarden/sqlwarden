...
async function _loadFresh(name: EditorThemeName): Promise<Extension> {
  switch (name) {
    case 'sqlwarden-dark':
      return (await import('./themes/sqlwarden-dark')).default
    case 'sqlwarden-light':
      return (await import('./themes/sqlwarden-light')).default
    ...
    case 'vscode-dark':
      return (await import('@uiw/codemirror-theme-vscode')).vscodeDarkInit({
        settings: { fontFamily: '' },
      })
    case 'vscode-light':
      return (await import('@uiw/codemirror-theme-vscode')).vscodeLightInit({
        settings: { fontFamily: '' },
      })
    case 'github-dark':
      return (await import('@uiw/codemirror-theme-github')).githubDark
    case 'github-light':
      return (await import('@uiw/codemirror-theme-github')).githubLight
    case 'dracula':
      return (await import('@uiw/codemirror-theme-dracula')).dracula
    case 'darcula':
      return (await import('@uiw/codemirror-theme-darcula')).darcula
    case 'gruvbox-dark':
      return (await import('@uiw/codemirror-theme-gruvbox-dark')).gruvboxDark
    case 'gruvbox-light':
      return (await import('./themes/gruvbox-light')).default
  }
}
