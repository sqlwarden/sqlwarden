...
func (app *application) grantEnvironmentRoleBinding(w http.ResponseWriter, r *http.Request) {
	var input struct {
...
func (app *application) revokeEnvironmentBinding(w http.ResponseWriter, r *http.Request) {
