...
//
// It owns three responsibilities: startup seeding and validation of the
// instance row ([Prepare]), validation of any candidate instance row
// ([Validate]), and resolution of effective settings for an organization or
// workspace ([Service]).
//
