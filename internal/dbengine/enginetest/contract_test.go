...
func (selectOneDriver) Connect(context.Context, dbengine.ConnectionConfig) error { return nil }
...
func (selectOneDriver) Dialect() dbengine.Dialect { return dbengine.DialectSQLite }
...
func TestHarnessAcceptsValidEngine(t *testing.T) {
	dbengine.Register(dbengine.Registration{
		...
		New: func() dbengine.Driver { return selectOneDriver{} },
	})
