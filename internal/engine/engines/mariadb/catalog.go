...
// "view"). Unlike mysql.CatalogTables, it excludes MariaDB's native SEQUENCE
// objects — information_schema.tables.table_type reports them as "SEQUENCE",
// a third value MySQL's table_type never produces — so callers must combine
// this with CatalogSequences rather than mysql.CatalogTables to avoid
// misreporting sequences as plain tables.
...
// CatalogSequences enumerates every native MariaDB sequence in database.
