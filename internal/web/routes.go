						...
						r.Route("/{env_id}", func(r chi.Router) {
							...
							r.Route("/connections", func(r chi.Router) {
								...
								r.Route("/{conn_id}", func(r chi.Router) {
									...
									r.Post("/query-sessions", app.startQuerySession)
									r.Post("/query-sessions/{query_session_id}/fetch", app.fetchQuerySession)
									r.Delete("/query-sessions/{query_session_id}", app.closeQuerySession)
									r.Post("/query", app.executeQuery)
									r.Get("/schema/capabilities", app.getConnectionSchemaCapabilities)
